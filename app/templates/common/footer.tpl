            ...
            <div class="relative max-w-screen-xl mx-auto px-8">
                <section class="relative z-10 p-6 bg-white shadow-lg md:flex md:items-center md:p-12 lg:p-16">
                    <div class="content md:pr-12">
                        <h2 class="text-3xl tracking-tight sm:text-4xl md:mt-4 xl:text-5xl">Станьте партнером
                            Laravel</h2>
                        <p class="mt-3 max-w-xl text-gray-600 sm:mt-5 md:max-w-2xl md:mt-8 md:text-lg">Партнеры Laravel
                            - это элитные магазины, предлагающие первоклассную разработку и консультирование на Laravel.
                            Каждый из наших партнеров может помочь вам создать красивый, хорошо продуманный проект.</p>
                    </div>
            ...
            <div class="px-8 pb-12 bg-gray-100 xl:px-20">
                ...
                <div class="mt-6 sm:mt-12 md:flex">
                    <div class="hidden sm:grid sm:grid-cols-2 sm:gap-x-4 sm:gap-y-8 md:w-1/2 lg:w-3/4 lg:grid-cols-4">
                        <div>
                            <span class="font-bold">Особенности</span>
                            <div class="mt-6">
                                <ul class="space-y-3 text-gray-600 text-sm">
                                    <li>
                                        <a href="releases" class="transition-colors hover:text-gray-700">Release
                                            Notes</a>
                                    </li>
                                    <li>
                                        <a href="installation" class="transition-colors hover:text-gray-700">Getting
                                            Started</a>
                                    </li>
                                    <li>
                                        <a href="routing" class="transition-colors hover:text-gray-700">Routing</a>
                                    </li>
                                    <li>
                                        <a href="blade" class="transition-colors hover:text-gray-700">Blade
                                            Templates</a>
                                    </li>
                                    <li>
                                        <a href="authentication" class="transition-colors hover:text-gray-700">Authentication</a>
                                    </li>
                                    <li>
                                        <a href="authorization" class="transition-colors hover:text-gray-700">Authorization</a>
                                    </li>
                                    <li>
                                        <a href="artisan" class="transition-colors hover:text-gray-700">Artisan
                                            Console</a>
                                    </li>
                                    <li>
                                        <a href="database" class="transition-colors hover:text-gray-700">Database</a>
                                    </li>
                                    <li>
                                        <a href="eloquent" class="transition-colors hover:text-gray-700">Eloquent
                                            ORM</a>
                                    </li>
                                    <li>
                                        <a href="testing" class="transition-colors hover:text-gray-700">Testing</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div>
                            <span class="font-bold">Ресурсы</span>
                            <div class="mt-6">
                                <ul class="space-y-3 text-gray-600 text-sm">
                                    <li>
                        ...
                        <div>
                            <span class="font-bold">Партнеры</span>
                            <div class="mt-6">
                                <ul class="space-y-3 text-gray-600 text-sm">
                                    <li>
                        ...
                        <div>
                            <span class="font-bold">Экосистема</span>
                            <div class="mt-6">
                                <ul class="space-y-3 text-gray-600 text-sm">
                                    <li>
                    ...
                    <div class="mt-10 max-w-md md:mt-0 md:w-1/2 lg:w-1/4">
                        <p class="text-xs text-gray-600 sm:text-sm">Laravel - это среда веб-приложений с выразительным
                            элегантным синтаксисом. Мы считаем, что развитие должно быть приятным и творческим, чтобы
                            приносить истинное удовлетворение. Laravel пытается облегчить разработку, упростив общие
                            задачи, используемые в большинстве веб-проектов.</p>
                        <p class="mt-6 text-xs text-gray-600 text-opacity-75 sm:text-sm">Laravel - торговая марка
                            Тейлора Отвелла.<br>Авторские права © 2011-2021 Laravel LLC.</p>
